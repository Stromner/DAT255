...
public class Seed {
    ...
    public void seedElements(Database db){
        ...
        db.addElement(1286, "ROSIN OIL", "(vapour pressure at 50 C more than 110 kPa, boiling point of more than 35 C)",3500, "3", "default", Arrays.asList(list.split(";")));

        list = "1;1.4;1.5;1.6;2.1;2.2;2.3;4.1;5.2"; // 6.1
        db.addElement(1541, "ACETONE CYANOHYDRIN", "(STABILIZED)",3500, "6.1", "default", Arrays.asList(list.split(";")));

        list = "1;1.4;1.5;1.6;4.1;5.2"; // 8
        db.addElement(1761, "CUPRIETHYLENEDIAMINE SOLUTION", "(STABILIZED)",3500, "8", "default", Arrays.asList(list.split(";")));

        list = "1;1.4;1.5;1.6;2.1;2.2;2.3;3;4.1;4:2;4.3;5.2;6.1;6.2;7;8;9"; // 5.1
        db.addElement(1474, "MAGNESIUM NITRATE", "SALT",3500, "5.1", "default", Arrays.asList(list.split(";")));

        list = "1;1.4;1.5;1.6;2.1;2.2;2.3;3;4.1;4:2;4.3;5.2;6.1;6.2;7;8;9"; // 5.2
        db.addElement(2909, "URANIUM", "RADIOACTIVE MATERIAL",3500, "5.1", "radioactive", Arrays.asList(list.split(";")));

        list = "1;1.4;1.5;1.6;4.1;5.2"; // 3
        db.addElement(1203, "MOTOR SPIRIT", "GASOLINE or PETROL",3500, "3", "flammable", Arrays.asList(list.split(";")));
